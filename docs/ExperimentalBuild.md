...
The [GitHub prerelease](https://github.com/diamondsea11/pipedal/releases/tag/pipedal-2.0.110-codex23)
for `pipedal-2.0.110-codex23` provides the complete
...
sudo apt install ./pipedal_2.0.110+codex23_arm64.deb
...
- Source tag: `pipedal-2.0.110-codex23`
